...
public class SJSwiftSideMenuController: UIViewController, UINavigationControllerDelegate {
    ...
    override public func viewDidLoad() {
        ...
        SJSwiftSideMenuController.navigator.delegate = self
        SJSwiftSideMenuController.navigator.navigationBar.barTintColor = UIColor.white
        SJSwiftSideMenuController.navigator.navigationBar.setBackgroundImage(UIImage(), for: UIBarMetrics.default)
        SJSwiftSideMenuController.navigator.navigationBar.shadowImage = UIImage()
        setUpContainers()
    ...
    private static func addDefaultLeftMenuButton(){
        ...
        button .imageEdgeInsets = UIEdgeInsets(top: 15, left: 5, bottom: 15, right: 55)
